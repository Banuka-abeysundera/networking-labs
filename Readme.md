...
![Router2 Configuration](screenshots/router2-config.png)
...
![Router3 Configuration](screenshots/router3-config.png)
...
![RIP Verification](screenshots/rip-verification.png)
